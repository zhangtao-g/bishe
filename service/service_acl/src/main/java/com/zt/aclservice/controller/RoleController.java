...
public class RoleController {
    ...
    public UnResult index(
        ...
        return UnResult.ok().data("items", pageParam.getRecords()).data("total", pageParam.getTotal());
    }
    ...
    public UnResult get(@PathVariable String id) {
        ...
        return UnResult.ok().data("item", role);
    }

    @ApiOperation(value = "新增角色")
    @PostMapping("save")
    public UnResult save(@RequestBody Role role) {
    ...
    @PutMapping("update")
    public UnResult updateById(@RequestBody Role role) {
